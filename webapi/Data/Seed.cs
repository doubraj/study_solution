        ...
        private static List<Product> getProductSeedData()
        {
            return new List<Product>
            {
                new Product
                {
                    ...
                    ImgUri = "U2Ftc3VuZyBHYWxheHkgQTMy.jpg",
                    Price = 6999,
                ...
                new Product
                {
                    ...
                    ImgUri = "U2Ftc3VuZyBHYWxheHkgUzIw.jpg",
                    Price = 15990,
                ...
                {
                    Name = "iPhone 11 64GB",
                    ImgUri = "aVBob25lIDExIDY0R0I=.jpg",
                    Price = 15490,
                ...
                new Product
                {
                    ...
                    ImgUri = "aVBob25lIDExIDEyOEdC.jpg",
                    Price = 17990,
                ...
                new Product
                {
                    ...
                    ImgUri = "U2Ftc3VuZyBHYWxheHkgUzIxIFVsdHJhIDVHIDI1NkdC.jpg",
                    Price = 34990,
                ...
                new Product
                {
                    ...
                    ImgUri = "QWNlciBOaXRybyA1IE9ic2lkaWFuIEJsYWNr.jpg",
                    Price = 18990,
                ...
                new Product
                {
                    ...
                    ImgUri = "RGVsbCBHNSAxNSBHYW1pbmcgKDU1MDApIEJsYWNr.jpg",
                    Price = 34990,
                ...
                new Product
                {
                    ...
                    ImgUri = "TWFjYm9vayBBaXIgMTNpbiBNMSBDWg==.jpg",
                    Price = 35490,
                ...
                new Product
                {
                    ...
                    ImgUri = "TGVub3ZvIExlZ2lvbiA1IFBybyAxNkFDSDZI.jpg",
                    Price = 46989,
                ...
                new Product
                {
                    ...
                    ImgUri = "SFAgUHJvQm9vayA0MzAgRzc=.jpg",
                    Price = 14990,
                ...
                new Product
                {
                    ...
                    ImgUri = "TGVub3ZvIElkZWFQYWQgNSAxNEFMQzA1.jpg",
                    Price = 13489,
                ...
                new Product
                {
                    ...
                    ImgUri = "QXN1cyBYNTE1SkEtQlE2NzVU.jpg",
                    Price = 15990,
                ...
                new Product
                {
                    ...
                    ImgUri = "TVNJIEdGNzUgVGhpbiAxMFVFLTA2NUNa.jpg",
                    Price = 35990,
                ...
                new Product
                {
                    ...
                    ImgUri = "SFAgMTVzLWZxMTkwMW5j.jpg",
                    Price = 13490,
                ...
                new Product
                {
                    ...
                    ImgUri = "TGVub3ZvIFRoaW5rUGFkIEUxNSBHZW4gMyAoQU1EKQ==.jpg",
                    Price = 24990,
                ...
                new Product
                {
                    ...
                    ImgUri = "UGxheVN0YXRpb24gNSBEdWFsU2Vuc2UgV2lyZWxlc3MgQ29udHJvbGxlcg==.jpg",
                    Price = 1899,
                ...
                new Product
                {
                    ...
                    ImgUri = "TG9naXRlY2ggRzI5IERyaXZpbmcgRm9yY2U=.jpg",
                    Price = 5990,
                ...
                new Product
                {
                    ...
                    ImgUri = "SHlwZXJYIENsb3VkIElJIEhlYWRzZXQ=.jpg",
                    Price = 1889,
                ...
                new Product
                {
                    ...
                    ImgUri = "U3RlZWxTZXJpZXMgQXJjdGlzIDk=.jpg",
                    Price = 5489,
                ...
                new Product
                {
                    ...
                    ImgUri = "RGVtb25zIFNvdWxzIFJlbWFrZSAtIFBTNQ==.jpg",
                    Price = 1999,
                ...
                new Product
                {
                    ...
                    ImgUri = "UmF0Y2hldCBhbmQgQ2xhbms6IFJpZnQgQXBhcnQgLSBQUzU=.jpg",
                    Price = 1999,
                ...
                new Product
                {
                    ...
                    ImgUri = "SHlwZXJYIENsb3VkIENvcmUgNy4x.jpg",
                    Price = 1569,
                ...
                new Product
                {
                    ...
                    ImgUri = "SHlwZXJYIENsb3VkIEZsaWdodA==.jpg",
                    Price = 3089,
                ...
                new Product
                {
                    ...
                    ImgUri = "Q3liZXJwdW5rIDIwNzcgLSBQUzQ=.jpg",
                    Price = 1389,
                ...
                new Product
                {
                    ...
                    ImgUri = "R3JhbmQgVGhlZnQgQXV0byBWIChHVEEgNSk6IFByZW1pdW0gRWRpdGlvbiAtIFBTNA==.jpg",
                    Price = 599,
                ...
                new Product
                {
                    ...
                    ImgUri = "UGxheVN0YXRpb24gNSBIRCBDYW1lcmE=.jpg",
                    Price = 1279,
                ...
                new Product
                {
                    ...
                    ImgUri = "UGxheVN0YXRpb24gNSBNZWRpYSBSZW1vdGU=.jpg",
                    Price = 790,
                ...
                new Product
                {
                    ...
                    ImgUri = "SmFicmEgU3BlYWsgNTEwIE1T.jpg",
                    Price = 2549,
                    Description = ""
                },
                new Product
                {
                    ...
                    ImgUri = "Um9sbGVpIGNlc3Rvdm7DrSBzdGF0aXY=.jpg",
                    Price = 799,
                ...
                new Product
                {
                    ...
                    ImgUri = "RnVqaWZpbG0gSW5zdGF4IG1pbmkgZmlsbSAyMGtz.jpg",
                    Price = 431,
                    Description = ""//30
                },
                new Product
                {
                    ...
                    ImgUri = "U2FuRGlzayBTRFhDIDY0R0IgRXh0cmVtZSBQcm8=.jpg",
                    Price = 759,
                ...
                new Product
                {
                    ...
                    ImgUri = "SHlwZXJYIFF1YWRDYXN0.jpg",
                    Price = 3489,
                ...
                {
                    Name = "SPC Gear SM950",
                    ImgUri = "U1BDIEdlYXIgU005NTA=.jpg",
                    Price = 2499,
                    Description = ""
                },
                new Product
                ...
                new Product
                {
                    ...
                    ImgUri = "Uk9ERSBOVC1VU0IgTWluaQ==.jpg",
                    Price = 2589,
